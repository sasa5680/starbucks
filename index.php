<!DOCTYPE html>
<!--느낌표 tab 해주면 처음 양식은 자동 완성이 된다-->
<html lang="ko">
<!--favicon이라는 파일이 루트에 있으면 자동으로 적용됨-->
...
<head>
  ...
  <!--SNS로 올라갈 때 우선적으로 보여줄 수 있는 항목들(open graph)-->
...
<body>
  ...
  <section class="visual">
    <div class="inner">
      ...
      <div class="fade-in">
        ...
        <img src="./images/visual_cup2_text.png" alt="new STARBUCKS CARAMMEL LATTE text" class="cup2 text">
      </div>
      <div class="fade-in">
  ...
  <section class="notice">
    ...
    <div class="promotion">
      <div class="swiper">
        <div class="swiper-wrapper">
          <div class="swiper-slide">
            <img src="./images/promotion_slide1.jpg" alt="2020 뉴 이어 스터벅스와 함께 즐기세요!">
            <a href="javascript:void(0)" class="btn">자세히 보기</a>
          </div>
          <div class="swiper-slide">
            <img src="./images/promotion_slide2.jpg" alt="2020 뉴 이어 스터벅스와 함께 즐기세요!">
            <a href="javascript:void(0)" class="btn">자세히 보기</a>
          </div>
          <div class="swiper-slide">
            <img src="./images/promotion_slide3.jpg" alt="2020 뉴 이어 스터벅스와 함께 즐기세요!">
            <a href="javascript:void(0)" class="btn">자세히 보기</a>
          </div>
          <div class="swiper-slide">
            <img src="./images/promotion_slide4.jpg" alt="2020 뉴 이어 스터벅스와 함께 즐기세요!">
            <a href="javascript:void(0)" class="btn">자세히 보기</a>
          </div>
          <div class="swiper-slide">
            <img src="./images/promotion_slide5.jpg" alt="기간 내 스타벅스 카드">
            <a href="javascript:void(0)" class="btn">자세히 보기</a>
          </div>
        </div>
      </div>
  ...
  <section class="rewards">
    ...
    <div class="inner">
      <div class="btn-group">
        <div class="btn btn--reverse sign-up">회원 가입</div>
  ...
  <section class="season-product scroll-spy">
    <div class="inner">
      <img src="./images/season_product_image.png" alt="season pro" class="product back-to-position to-right delay-0">
  ...
  <section class="reserve-coffee scroll-spy">
    <div class="inner">
      ...
      <img src="./images/reserve_logo.png" alt="reservelogo" class="reserve-logo back-to-position to-right delay-0">

      <div class="text-group">
        <img src="./images/reserve_text.png" alt="ddd" class="description back-to-position to-right delay-1">
        <div class="more back-to-position to-right delay-2">
          <a href="javascript:void(0)" class="btn btn--gold">자세히 보기</a>
        </div>
      </div>
      <img src="./images/reserve_image.png" alt="dddd" class="product back-to-position to-left delay-3">
    </div>
  </section>
  ...
  <section class="reserve-store">
    <div class="inner">
      ...
      <div class="medal">
        <div class="front">
          <img src="./images/reserve_store_medal_front.png" alt="medal">
        </div>
        <div class="back">
          <img src="./images/reserve_store_medal_back.png" alt="medal">
  ...
  <section class="awards">
    <div class="inner">
      ...
      <div class="swiper">
        <div class="swiper-wrapper">
          <div class="swiper-slide">
            <img src="./images/awards_slide1.jpg" alt="award1">
          </div>

          <div class="swiper-slide">
            <img src="./images/awards_slide2.jpg" alt="award2">
          </div>

          <div class="swiper-slide">
            <img src="./images/awards_slide3.jpg" alt="award3">
          </div>

          <div class="swiper-slide">
            <img src="./images/awards_slide4.jpg" alt="award4">
          </div>

          <div class="swiper-slide">
            <img src="./images/awards_slide5.jpg" alt="award5">
          </div>

          <div class="swiper-slide">
            <img src="./images/awards_slide6.jpg" alt="award6">
          </div>

          <div class="swiper-slide">
            <img src="./images/awards_slide7.jpg" alt="award7">
          </div>

          <div class="swiper-slide">
            <img src="./images/awards_slide8.jpg" alt="award8">
          </div>

          <div class="swiper-slide">
            <img src="./images/awards_slide9.jpg" alt="award9">
          </div>

          <div class="swiper-slide">
            <img src="./images/awards_slide10.jpg" alt="award10">
          </div>
        </div>
      </div>
